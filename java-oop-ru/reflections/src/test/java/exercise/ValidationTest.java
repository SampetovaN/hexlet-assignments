...
class ValidationTest {
    ...
    void testAdvancedValidate() {
        Address address1 = new Address("Russia", "Ufa45", "Lenina", "54", null);
        ...
        expected2.put("country",List.of("can not be null", "length less than 4"));
        assertThat(result2).isEqualTo(expected2);

        Address address3 = new Address("USA", null, null, null, "1");
        Map<String, List<String>> result3 = Validator.advancedValidate(address3);
        Map<String, List<String>> expected3 = new HashMap<>();
        expected3.put("city",List.of("can not be null", "length less than 4"));
